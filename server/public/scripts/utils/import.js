...
var _MaterialUI = MaterialUI,
  ...
  ListItemIcon = _MaterialUI.ListItemIcon,
  ListItemText = _MaterialUI.ListItemText,
  LinearProgress = _MaterialUI.LinearProgress,
  MenuItem = _MaterialUI.MenuItem,
  MenuList = _MaterialUI.MenuList,
  Paper = _MaterialUI.Paper,
  Popper = _MaterialUI.Popper,
  Popover = _MaterialUI.Popover,
